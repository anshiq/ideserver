...
const (
	Greeter_SayHello_FullMethodName      = "/ideserver.Greeter/SayHello"
	Greeter_SayHelloAgain_FullMethodName = "/ideserver.Greeter/SayHelloAgain"
)
